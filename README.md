<div align="center">
  ...
  <p>
    ...
    <a href="https://prisma.io"><img src="https://img.shields.io/badge/Prisma-5.14-2D3748?style=for-the-badge&logo=prisma&logoColor=white" alt="Prisma" /></a>
    <a href="./LICENSE"><img src="https://img.shields.io/badge/License-MIT-00450D?style=for-the-badge" alt="License" /></a>
  </p>

  <p>
    <em>Bridging off-campus highway dhabas on the Ashta-Kothri highway directly to student hostel blocks (Blocks 1–6 & Girls Gates 1–2). Custom-built for non-tech kitchen literacy, low-glare night riding, and gate handshake security.</em>
  </p>
...
```mermaid
graph TD
    A[🎓 Customer App - Flutter] -->|REST / WebSockets| D(⚡ Node.js Express API & Socket.io Server)
    ...
    D -->|ORM Persistence| F[(PostgreSQL Database)]
    D -->|Push Alerts| G[🔥 Firebase Cloud Messaging]
    D -->|UPI Checkout| H[💳 Razorpay Gateway]
```
...
├── backend/                 # Node.js + Express + TypeScript Server, Socket.io, Prisma PostgreSQL & Razorpay
├── Docs/                    # Complete Architectural Specifications & Deployment Blueprints
├── .gitignore
├── LICENSE
└── README.md
```
...
- **Live Logistics Canvas Map**: Dynamic non-stacking runner pin placement algorithm (`LiveCommandCenter.tsx`).
...
📍 **Compiled Outputs:**
- `apps/customer_app/build/app/outputs/flutter-apk/app-release.apk` (**49 MB**)
- `apps/vendor_app/build/app/outputs/flutter-apk/app-release.apk` (**49 MB**)
- `apps/driver_app/build/app/outputs/flutter-apk/app-release.apk` (**47 MB**)

---

## 🛡️ Verification & Code Cleanliness
...
[✓] Customer App (Flutter 3.44.8 Release APK) : `app-release.apk` BUILT (0 Analyze Errors)
[✓] Vendor App   (Flutter 3.44.8 Release APK) : `app-release.apk` BUILT (0 Analyze Errors)
[✓] Driver App   (Flutter 3.44.8 Release APK) : `app-release.apk` BUILT (0 Analyze Errors)
```
